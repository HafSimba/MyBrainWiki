...
Claude Code can search the web through Ollama’s web search API. See the [web search documentation](https://docs.ollama.com/capabilities/web-search) for setup and usage.
